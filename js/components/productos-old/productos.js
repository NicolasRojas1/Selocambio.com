...
products.forEach((products) => {
  ...
  <img class="img_prod" src="${products.img}" alt="Imagen de ${products.nombre}"></img>
  <h2>${products.nombre}</h2>
  <h4>${products.vendedor}</h4>
  <p class="description">${products.descripcion}</p>
  <a href="http://wa.me/57${products.telefono}?text=Hola ${products.vendedor}, vi tu oferta de ${products.nombre} 
